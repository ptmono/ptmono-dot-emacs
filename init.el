...
(load (concat d-dir-emacs "config/cedet-config.el") nil t t) ; cedet have to load before other. See worknote2#1109230830
...
determines this value.")
  ...
  (when d-cygwin-p
    ...
    (let* ((cygwin-root (concat d-windows-emacsd-dir "/cygwin"))
      ...
      (setenv "SVN_EDITOR" "C:\\emacsd\\emacs\\bin\\emacs.exe")
...
(if (and (d-not-windowp) (not d-TEST))
    (mapc
     'load
     (list
      ;"nxhtml-config"
